...
if (isset($_POST['stationNum'])) {
    $stationNumber = $_POST['stationNum'];
        $query = "Select Station_Number, Year, Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec, Annual from `rmit-one.weather_analysis.tbl_temperature_details_maximum` where Station_Number = " . $stationNumber." order by Year DESC LIMIT 5" ;
